...
function passiveTrack(){
  ...
  _safeFetch(API+'/api/widget/beacon',{method:'POST',headers:{'Content-Type':'application/json'},
...
function startSession(){
  ...
  _safeFetch(API+'/api/widget/init',{method:'POST',headers:{'Content-Type':'application/json'},
...
function trackPage(){
  ...
  _safeFetch(API+'/api/widget/activity',{method:'POST',headers:{'Content-Type':'application/json','X-Chat-ID':chatId},
